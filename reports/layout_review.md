...
|---|---|---|---|---|---|---|---|---|---|
| C_AVDD_P19 | 19 (AVDD) | ベタ | 3.10 | 配線経路なし | — | はい | — | GND | 0.15 |
| C_AVDD_H | 21 (AVDD) | ベタ | 8.47 | 配線経路なし | — | はい | — | GND | 0.77 |
| C_AVDD_B | 21 (AVDD) | ベタ | 8.62 | 配線経路なし | — | はい | — | GND | 0.00 |
| C_AVDD_H | 22 (AVDD) | ベタ | 8.39 | 配線経路なし | — | はい | — | GND | 0.77 |
| C_VREFP_10u | 24 (VREFP) | 配線 | 6.46 | 9.40 | 0 | はい | OK | AVSS | 1.06 |
| C_VREFP_100n | 24 (VREFP) | 配線 | 3.40 | 6.47 | 0 | はい | OK | AVSS | 0.15 |
| C_VREFP_10n | 24 (VREFP) | 配線 | 2.83 | 2.55 | 0 | はい | OK | AVSS | 0.10 |
| C_VCAP4 | 26 (VCAP4) | 配線 | 5.24 | 9.00 | 2 | はい | **NG** | AVSS | 0.00 |
| C_VCAP1 | 28 (VCAP1) | 配線 | 9.89 | 12.16 | 2 | はい | **NG** | AVSS | 0.79 |
| C_VCAP1_H | 28 (VCAP1) | 配線 | 1.36 | 1.36 | 0 | はい | OK | AVSS | 1.08 |
| C_VCAP2 | 30 (VCAP2) | 配線 | 1.53 | 1.53 | 0 | はい | OK | AVSS | 0.36 |
| C_AVDD_P36 | 56 (AVDD) | ベタ | 16.29 | 配線経路なし | — | はい | — | GND | 0.89 |
| C_AVDD_P31 | 56 (AVDD) | ベタ | 14.13 | 配線経路なし | — | はい | — | GND | 1.73 |
...
| C_VCAP3 | 55 (VCAP3) | 配線 | 3.36 | 3.67 | 2 | はい | **NG** | AVSS | 2.75 |
| C_VCAP3_H | 55 (VCAP3) | 配線 | 2.10 | 2.10 | 0 | はい | OK | AVSS | 2.91 |
| C_AVDD_P59 | 59 (AVDD) | ベタ | 4.50 | 配線経路なし | — | はい | — | GND | 0.15 |
| C_DVDD_P58 | 48 (DVDD) | 配線 | 11.48 | 22.11 | 0 | はい | OK | GND | 0.65 |
| C_DVDD_H | 48 (DVDD) | 配線 | 12.09 | 17.14 | 0 | はい | OK | GND | 0.70 |
| C_DVDD_P40 | 50 (DVDD) | 配線 | 6.23 | 13.67 | 0 | はい | OK | GND | 1.00 |
| C_DVDD_10u | 50 (DVDD) | 配線 | 9.89 | 18.01 | 0 | はい | OK | GND | 0.42 |
| C_AVSS_P17 | 20 (AVSS) | ベタ | 6.28 | 配線経路なし | — | はい | — | GND | 0.15 |
| C_AVSS_H | 20 (AVSS) | ベタ | 9.49 | 配線経路なし | — | はい | — | GND | 0.55 |
| C_AVSS_P30 | 32 (AVSS) | ベタ | 9.29 | 配線経路なし | — | はい | — | GND | 0.15 |
| C_AVSS_P37 | 57 (AVSS) | ベタ | 16.22 | 配線経路なし | — | はい | — | GND | 0.15 |
| C_AVSS_P60 | 58 (AVSS) | ベタ | 17.79 | 配線経路なし | — | はい | — | GND | 0.15 |
| C_AVSS_B | 58 (AVSS) | ベタ | 19.23 | 配線経路なし | — | はい | — | GND | 0.21 |

**配線で配る電源のうち、ビアを挟んでいるのは 3 経路。**

- `C_VCAP4` → ADS ピン 26（VCAP4）: ビア 2 個・銅箔 9.00 mm
- `C_VCAP1` → ADS ピン 28（VCAP1）: ビア 2 個・銅箔 12.16 mm
- `C_VCAP3` → ADS ピン 55（VCAP3）: ビア 2 個・銅箔 3.67 mm
...
| ADS_CS_N | 762 | 49 | 0 | **0** | 0 | 連続 |
| ADS_DRDY_N | 976 | 22 | 0 | **0** | 0 | 連続 |
| USB_DP | 359 | 61 | 0 | **0** | 0 | 連続 |
| USB_DM | 467 | 55 | 0 | **0** | 0 | 連続 |

## 5. 入力ネットの直下（In2 電源ベタ）

In2 は電源ベタ（AVDD / AVSS / USB_5V / VDD_ESP ほか）。

> **表の「またぐ」は問題ではない。** 入力配線のリターン電流が流れるのは**直下ではなく最も近いリファレンス面**で、この基板ではそれが **In1（GND、1 枚もの・2493.4 mm²・基板面積の 90%）**。In1 に切れ目が無い以上リターン経路は連続しており（第 4 節で実測）、In2 の境界越えはリターンの断絶にはならない。下表は「入力の下に何があるか」の記録であって合否ではない。

| 入力 | またぐ領域数 | 遷移回数 | 領域 |
|---|---|---|---|
| IN1P | 3 | 2 | AVSS, AVDD, (no fill) |
| IN1N | 3 | 6 | AVSS, (no fill), AVDD |
| IN2P | 3 | 2 | AVSS, (no fill), AVDD |
| IN2N | 3 | 6 | AVSS, (no fill), AVDD |
| IN3P | 3 | 2 | AVSS, (no fill), AVDD |
| IN3N | 3 | 6 | AVSS, (no fill), AVDD |
| IN4P | 3 | 2 | AVSS, (no fill), AVDD |
| IN4N | 3 | 6 | AVSS, (no fill), AVDD |
| IN5P | 3 | 2 | AVSS, (no fill), AVDD |
| IN5N | 3 | 6 | AVSS, (no fill), AVDD |
| IN6P | 3 | 2 | AVSS, (no fill), AVDD |
| IN6N | 3 | 6 | AVSS, (no fill), AVDD |
| IN7P | 3 | 2 | AVSS, (no fill), AVDD |
| IN7N | 3 | 6 | AVSS, (no fill), AVDD |
| IN8P | 3 | 2 | AVSS, AVDD, (no fill) |
| IN8N | 3 | 6 | AVSS, (no fill), AVDD |

## 6. 差動ペアの長さ差と間隔

| ペア | P 側 [mm] | N 側 [mm] | 差 [mm] | 最小間隔 [mm] |
|---|---|---|---|---|
| IN1P/IN1N | 22.38 | 19.80 | 2.58 | 0.331 |
| IN2P/IN2N | 20.38 | 17.80 | 2.58 | 0.331 |
| IN3P/IN3N | 18.38 | 15.80 | 2.58 | 0.330 |
| IN4P/IN4N | 16.38 | 13.80 | 2.58 | 0.330 |
| IN5P/IN5N | 14.80 | 14.22 | 0.58 | 0.441 |
| IN6P/IN6N | 16.80 | 16.21 | 0.58 | 0.330 |
| IN7P/IN7N | 18.79 | 18.21 | 0.58 | 0.331 |
| IN8P/IN8N | 20.79 | 20.21 | 0.58 | 0.331 |
...
| J9 USB D+/D- length delta | 9.671 mm (D+ 34.036, D- 43.706) | < 45 mm (Full Speed, H-2) | OK |
...
| J11 ESP32 antenna clear of the board | module right edge 175.29 mm, board right edge 181.62 mm, overhang -6.34 mm | antenna over a cut-out or off the edge | **要判断** |
...
| 部品 | 現在 [mm] | 調べた位置 | 結果 |
|---|---|---|---|
| C_VCAP3 → U_ADS.55 | 3.36 | 0 | no position between 0.4 mm and 3.36 mm of the pin clears the neighbouring bodies, courtyards and copper while reaching the pin without a via |
