...
`C69932`(TPS72325) `C476817`(U_ADS) `C701341`(U_MCU) `C84268`(D_LED) `C84681`(U_USB)
...
### (4) Confirm Parts Placement で見る向き — **11 点を固有名で**

`fab/preview_top.png` と `fab/assembly_top.pdf` を横に置いて、下の 11 点を 1 つずつ確認する。
...
| 9 | `J1` | USB-C 16P | **90°** | この基板で唯一 0° でない部品。プレビューでコネクタ開口が基板端を向いているか |
...
| 11 | `U_MCU` | ESP32-WROOM-32E | 0° | アンテナが基板の**内側**を向いている（§7 の既知事項。向き自体は正） |
...
- ODB++ のネットリスト点 **678 = パッド 439 ＋ ビア 239**
