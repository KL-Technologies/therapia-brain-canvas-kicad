...
| PCB | `Y6-10641515A` — 4 層 / 1.6 mm / Green / ENIG / **JLC パネル化 1×1・四辺 12.5 mm レール（86.82×70.01 mm）** / **5 パネル** / 3 日 / **$46.00** |
| PCBA | `SMT026082862202-10641515A` — **Standard** / Top 片面 / **2 パネル** / 5〜6 日 / **$226.91**（部品 $141.72・フィーダー $44.37・段取り $25.56・ステンシル $8.21 ほか）/ Confirm Parts Placement = Yes（自動確認しない） |
| 合計 | **$272.91 ＋送料**、出荷予定 2026-09-05（同カートの Ganglion 2 品目は触っていない） |
