...
最終更新: 2026-08-29 13:10 / 担当: S0–S2 → S3・S4 → S5・S6 → S7・S8 → S9 → L7〜L9・H・S8 再出力・S9 再投入 → 独立機能レビュー反映（BOM のみ 4 件・銅箔不変） → **S3_sim（ngspice）＋ R29-6 反映（BOM のみ 1 件・銅箔不変）**
...
| PCB | `Y7-10641515A` — 4 層 / 1.6 mm / Green / ENIG / **JLC パネル化 1×1・四辺 12.5 mm レール（86.82×70.01 mm）** / **5 パネル** / 3 日 / **$46.00** |
| PCBA | `SMT026082960247-10641515A` — **Standard** / Top 片面 / **2 パネル** / 5〜6 日 / **$227.07**（部品 $141.89・フィーダー $44.37・段取り $25.56・ステンシル $8.21 ほか）/ Confirm Parts Placement = Yes（自動確認しない） |
| 合計 | **$273.07 ＋送料**（同カートの Ganglion 2 品目は触っていない） |
...
> ### ⚠ 2026-08-29: BOM が 5 件変わった。**カートの部品表を入れ直してから決済すること**
>
...
> なので **PCB（Y6/Y7）は入れ直さなくてよい**が、**PCBA 側の BOM は現在カートにある版が古い**。
>
> | designator | 旧 | 新 |
> |---|---|---|
